...
<tileset version="1.4" tiledversion="1.4.3" name="tileset" tilewidth="16" tileheight="16" tilecount="336" columns="16">
 <image source="tileset.png" width="256" height="336"/>
 <terraintypes>
  <terrain name="grass" tile="17"/>
  <terrain name="sand" tile="20"/>
  <terrain name="forest1" tile="177"/>
  <terrain name="forest2" tile="180"/>
 </terraintypes>
 <tile id="0" terrain=",,,0"/>
